...
const MOCK_REVIEWS: Review[] = [
  ...
  // Reviews for product "new" - Bright Matte Sunscreen
  {
    ...
    rating: 5,
    review: "Kem chống nắng này tuyệt vời cho da dầu! Kiểm soát dầu rất hiệu quả, da mình không còn bóng nhờn suốt cả ngày. Kết cấu matte tự nhiên, không để lại vệt trắng.",
    date: "2 tuần trước",
  ...
  },
  {
    ...
    name: "Trần Văn Đức",
    rating: 5,
    review: "Sản phẩm tốt nhất cho da dầu mình từng dùng! Vừa chống nắng vừa kiểm soát dầu, da mình giờ matte mịn cả ngày. Rất recommend!",
    date: "1 tháng trước",
  ...
  },
  {
    ...
    name: "Lê Thị Mai",
    rating: 5,
    review: "Bright Matte Sunscreen đã thay đổi làn da dầu của mình! Không còn phải dùng giấy thấm dầu nhiều lần nữa. Da mình giờ sáng và mịn hơn rất nhiều.",
    date: "3 tuần trước",
  ...
  },
  {
    ...
    name: "Phạm Thị Lan",
    rating: 4,
    review: "Kem chống nắng tốt, kiểm soát dầu hiệu quả. Chỉ cho 4 sao vì giá hơi cao, nhưng chất lượng xứng đáng với giá tiền.",
    date: "2 tuần trước",
    beforeImage: "/image-product/kcnxanhduong/1.png",
    afterImage: "/image-product/kcnxanhduong/8.png",
    verified: true,
  ...
  },
  {
    ...
    rating: 5,
    review: "Đã dùng được 2 tháng, da dầu của mình đã cải thiện rất nhiều. Kem này vừa bảo vệ khỏi tia UV vừa kiểm soát dầu rất tốt. Da mình giờ tự nhiên và mịn màng hơn!",
    date: "1 tuần trước",
    beforeImage: "/image-product/kcnxanhduong/6.png",
    afterImage: "/image-product/kcnxanhduong/7.png",
    verified: true,
