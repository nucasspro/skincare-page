...
export default function HeroSection() {
  return (
    <section className="relative min-h-[85vh] md:min-h-screen w-full overflow-hidden flex items-center justify-center snap-center z-10">
      ...
      <div className="relative z-10 w-full h-[85vh] md:h-screen flex flex-col items-center justify-start pt-[40px] md:pt-[100px] px-10 pb-0">
        <div className="text-center w-full max-w-[1200px] order-1">
          <h1 className="text-heading-2 mb-2 md:mb-5">
            CELLIC BRIGHT MATTE SUNCREEN
          </h1>
          <p className="text-body-large mt-2 md:mt-4 !leading-[1.1]">
