...
export default function LandingPage() {
  ...
  return (
    ...
    >
      ...
      <body>
        <div className="bg-[linear-gradient(to_bottom,#F8FBFD_0%,#F6FAFD_14%,#EDF5FC_28%,#D9EAF9_42%,#ECF4FC_57%,#DBEBFA_71%,#EEF6FC_85%,#F8FCFD_100%)]">
          ...
          {/* 3 lớp toàn diện - ngoc */}
          <section className="px-[1.1vw] relative z-10 w-full">
            <div className="max-w-300 w-full mx-auto px-[1.1vw]">
              <h2 className="text-center section-title text-[clamp(20px,2.8vw,40px)] font-extrabold text-[#2F5C91] uppercase tracking-tight font-heading">
                Tính năng bảo vệ 3 lớp toàn diện
              </h2>
              <div
                className="w-full h-full bg-center bg-cover rounded-lg flex"
                style={{
                  backgroundImage: "url('/landing-page/PAGE 3/Group 3.png')",
                }}
              >
                <div className="flex flex-1 flex-col gap-6 sm:gap-8 md:gap-14 pt-8 pb-14">
                  <h3 className="section-content text-right text-[clamp(10px,1.7vw,24px)] font-bold text-[#2F5C91] font-heading leading-relaxed">
                  ...
                  <div className="flex justify-end">
                    <button className="cursor-pointer rounded-full border-2 border-[#2F5C91] p-0.5 bg-[#CFE5F5]">
                      <div className="rounded-full border-2 border-white px-6 py-1.5 sm:px-12 md:px-20">
                        <span className="text-[#2F5C91] font-bold font-heading text-sm sm:text-base md:text-lg whitespace-nowrap">
                          Xem thêm
                        </span>
                      </div>
                    </button>
          ...
          {/* section 4 - ngoc */}
          <section className="relative flex w-full items-stretch mt-10">
            <div className="absolute left-[5%] -top-[5%] h-full w-1/3 z-10 flex items-center justify-center">
              <img
            ...
            <div
              className="ml-[20%] mr-24 pl-[18%] flex-1 bg-linear-to-b from-[#D2E0E9] via-[#DEE9F0] to-[#EAF1F7] rounded-[70px] px-12 py-2 flex flex-col gap-4 ">
              <h2 className="section-title font-extrabold uppercase tracking-tight text-[#3a76a5]">
                Thành Phần
              </h2>
              <div>
                <h3 className="section-content font-extrabold uppercase mb-1 font-heading text-[#3a76a5]">
                  Màng lọc chống nắng hiện đại
                </h3>
                <div className="text-[#137294]">
                  Ultrafine Titanium Dioxide, Nano Zinc Oxide, Uvinul A Plus, Octinoxate
                </div>
              </div>

              <div>
                <h3 className="section-content font-extrabold uppercase mb-4 font-heading text-[#3a76a5]">
                  PDRN Thực Vật
                </h3>
                <div className="text-[#137294]">
              ...
              <h3 className="section-content font-extrabold uppercase mb-3 font-heading text-[#3a76a5]">
                Propanediol
              </h3>
              <div className="text-[#137294]">
