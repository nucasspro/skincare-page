...
function Step({ imageSrc, alt, text }: StepProps) {
    return (
        <div className="flex flex-col items-center justify-start h-full flex-1">
            ...
            <p className="section-content font-normal text-sm mt-4 text-center flex-grow w-full">{text}</p>
        </div>
    )
}
...
function ReviewCard({ rating, review, author, date }: ReviewCardProps) {
    return (
        <div className="bg-white p-8 rounded-lg border border-slate-100 flex flex-col flex-1 min-h-[300px]">
            ...
            <p className="section-content font-normal text-sm text-slate-600 mb-6 leading-relaxed flex-grow text-left">
                {review}
            </p>
...
function BenefitItem({ imageSrc, text }: BenefitItemProps) {
    return (
        <div className="flex flex-col md:flex-row gap-8 items-center max-w-[90%] mx-auto my-4">
            ...
            <p className="text-left text-lg md:text-xl leading-relaxed pr-30" style={{ lineHeight: '1.5', fontFamily: MontserratFont.style.fontFamily }}>
                {text}
            </p>
        </div>
    )
...
export default function LandingPage() {
    ...
    return (
        ...
        <div
            className="w-full bg-[#DFEAF8] select-none"
      ...
      `}</style>
            ...
            <Image
                src={isMobile ? "/landing-page/section-1-to-7_mobile.png" : "/landing-page/section-1-to-7-desktop.png"}
                alt="Long image"
                width={1920}
                height={1080}
            ...
            <section className="py-[5.5vw] bg-[#DFEAF8] relative overflow-visible z-10 mt-[4.1vw]">
                <div className="w-[80vw] mx-auto px-[1.1vw] relative z-10">
                    {/* Image at top right corner of border */}
                    <div className="absolute top-[-12vw] right-[-12vw] z-30">
                        <Image
                    ...
                    <div className="relative border-2 border-[#3a76a5] rounded-[0.55vw] bg-white z-10 overflow-visible">
                        ...
                        <div className="flex flex-row bg-[#DFEAF8]">
            ...
            <section className="py-10 bg-[#DFEAF8] relative z-10 w-full mt-[60px]">
            ...
            <section className="py-10 bg-[#DFEAF8] relative z-10 w-full">
