    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl p-6 md:p-8 border border-stone-200 shadow-sm hover:shadow-md transition-shadow duration-300">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-xl font-bold text-gray-900 h-heading">Phương thức thanh toán</h2>
        </div>
                  ...
                  <div className="flex-1">
                    <div className="flex items-start justify-between gap-4">
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-stone-600 mb-2 p-desc">{method.description}</p>
                        <p className="text-xs text-stone-500 p-desc">{method.details}</p>
                      </div>
        ...
        {selectedPayment === "bank" && (
          <div className="mt-6 p-5 bg-blue-50 border-2 border-blue-200 rounded-xl animate-in slide-in-from-top-4 fade-in duration-300">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex justify-between items-center">
                ...
                <span className="text-blue-900 font-bold font-mono">{bankInfo.accountNumber}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-blue-800 font-medium">Chủ tài khoản:</span>
                <span className="text-blue-900 font-semibold">{bankInfo.accountName}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-blue-800 font-medium">Ngân hàng:</span>
                <span className="text-blue-900">{bankInfo.bank}</span>
              </div>
              <div className="flex justify-between items-center">
            ...
            <div className="mt-4 pt-4 border-t border-blue-200">
              <p className="text-xs text-blue-700 p-desc">
        ...
        {selectedPayment === "cod" && (
          <div className="mt-6 p-5 bg-green-50 border-2 border-green-200 rounded-xl animate-in slide-in-from-top-4 fade-in duration-300">
            <div className="flex items-start gap-3">
              <div className="w-8 h-8 bg-green-600 rounded-lg flex items-center justify-center flex-shrink-0">
                <Check className="w-5 h-5 text-white" />
              </div>
              <div className="flex-1">
                <h4 className="text-sm font-bold text-green-900 mb-2">Thanh toán khi nhận hàng</h4>
                <ul className="text-xs text-green-800 space-y-1 p-desc">
      ...
      <div className="flex gap-4">
        <button
          type="button"
          onClick={onBack}
          className="flex-1 px-6 py-4 border-2 border-stone-300 rounded-xl text-gray-700 font-medium hover:bg-stone-50 hover:border-stone-400 transition-all duration-200"
        >
          ← Quay lại
        </button>
        <button
          ...
          className="flex-1 px-6 py-4 bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-white font-bold rounded-xl hover:shadow-xl hover:scale-[1.02] transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 flex items-center justify-center gap-2"
        >
          Xác nhận đơn hàng
